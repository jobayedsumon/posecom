@extends('layouts.app', ['activePage' => 'brand', 'titlePage' => __('Edit Brand')])
...
@section('content')
    <div class="content">
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-6">
                    <form method="post" action="{{ route('brands.update', $brand->id) }}" autocomplete="on" class="form-horizontal" enctype="multipart/form-data">
                        @csrf
                        @method('patch')
                                    ...
                                    <div class="col-sm-7">
                                        <div class="form-group{{ $errors->has('name') ? ' has-danger' : '' }}">
                                            <input class="form-control{{ $errors->has('name') ? ' is-invalid' : '' }}" name="name" id="input-name" type="text"
                                                   placeholder="{{ __('Brand Name') }}" value="{{ $brand->name }}" required="true" aria-required="true"/>
                                            @if ($errors->has('name'))
...
{{--                                                    <td class="td-actions">--}}
{{--                                                        <a href="{{ route('brands.edit', $brand->id) }}"><i class="material-icons">edit</i></a>--}}
{{--                                                    </td>--}}
