...
<head>
    ...
    <title>Bonique - services page</title>
                ...
                <div class="col-12">
                    ...
                    <div class="offcanvas_menu_wrapper">
                        ...
                        <div class="language_currency top">
                            <ul>
                                <li class="language"><a href="#"><img src="assets/img/icon/language.png" alt=""> English <i class="icon-right ion-ios-arrow-down"></i></a>
                                            ...
                                            <li class="mega_items"><a href="shop.html">shop<i class="fa fa-angle-down"></i></a> 
                                                <div class="mega_menu">
                                                    <ul class="mega_menu_inner">
                                                        ...
                                                        <li><a href="#"><img src="assets/img/bg/banner_menu.jpg" alt=""></a></li>
                                                    </ul>
                                                </div>
                                            </li>
